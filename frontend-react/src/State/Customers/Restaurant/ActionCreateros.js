...
// Get All Nearby Restaurants Actions (similar structure for other actions)
export const getAllNearbyRestaurantsRequest = () => ({
  type: actionTypes.GET_NEARBY_RESTAURANTS_REQUEST,
});

export const getAllNearbyRestaurantsSuccess = (restaurants) => ({
  type: actionTypes.GET_NEARBY_RESTAURANTS_SUCCESS,
  payload: restaurants,
});

export const getAllNearbyRestaurantsFailure = (error) => ({
  type: actionTypes.GET_NEARBY_RESTAURANTS_FAILURE,
  payload: error,
});
